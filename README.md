...
<p align="center">
  <a href="https://github.com/kory-kaai/collab-kit"><strong>collab-kit</strong></a> scaffolds your repo on day 1. <strong>shipkit</strong> ships it on day 30.
</p>
...
npx @korykaai/shipkit release --patch
npx @korykaai/shipkit publish --yes
```
...
```bash
git clone https://github.com/kory-kaai/shipkit.git
cd shipkit
npm test
